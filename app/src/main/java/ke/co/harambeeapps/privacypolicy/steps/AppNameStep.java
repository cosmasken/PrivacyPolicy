 ...
 */
public class AppNameStep extends Step<String> {

    private EditText appNameView;

    public AppNameStep(String stepTitle) {
        super(stepTitle);
    }
    ...
    protected View createStepContentLayout() {
        ...
        appNameView = new EditText(getContext());
        appNameView.setSingleLine(true);
        appNameView.setHint("App Name");

        appNameView.addTextChangedListener(new TextWatcher() {
            @Override
    ...
    public String getStepData() {
        ...
        Editable appName = appNameView.getText();
    ...
    public String getStepDataAsHumanReadableString() {
        ...
        String appName = getStepData();
        return !appName.isEmpty() ? appName : "(Empty)";
    }
